...
- **Internal Use**: Internal business operations and applications
- **SaaS Applications**: Software-as-a-Service applications where the software is not distributed to end users
- **Enterprise Applications**: Large-scale enterprise deployments
...
Commercial license holders receive the following benefits:
...
- **Support Channels**: Email and/or phone support during business hours
- **Response Times**: Guaranteed response times based on your support tier
- **Bug Fixes**: Priority bug fixes and patches
- **Security Updates**: Immediate access to security patches and updates
- **Version Upgrades**: Access to major and minor version upgrades during the license term

### 6. Pricing and Payment

Commercial licensing is available on a subscription or perpetual basis. Pricing is determined by:

- Number of developers/users
- Deployment type (on-premise, cloud, SaaS)
- Support tier required
- License term (annual subscription or perpetual)
...
- **Email**: licensing@geoknoesis.com
- **Website**: https://geoknoesis.com/licensing
- **Sales**: sales@geoknoesis.com

---

*This document provides general terms. Your specific commercial license agreement may contain additional terms and conditions.*
