...
class IndyBlockchainAnchorClientTest {
    ...
    @Test
    fun `should create client with testnet chain ID`() =
        runBlocking<Unit> {
            val client =
    ...
    @Test
    fun `should anchor payload using opt-in in-memory test mode`() =
        runBlocking<Unit> {
            val client =
                IndyBlockchainAnchorClient(
                    chainId = IndyBlockchainAnchorClient.BCOVRIN_TESTNET,
    ...
    @Test
    fun `should fail closed on write without signer when test mode is off`() =
        runBlocking<Unit> {
            val client =
                IndyBlockchainAnchorClient(
                    chainId = IndyBlockchainAnchorClient.BCOVRIN_TESTNET,
    ...
    @Test
    fun `should read anchored payload`() =
        runBlocking<Unit> {
            val client =
                IndyBlockchainAnchorClient(
                    chainId = IndyBlockchainAnchorClient.BCOVRIN_TESTNET,
    ...
    @Test
    fun `should handle custom chain ID`() =
        runBlocking<Unit> {
            val client =
                IndyBlockchainAnchorClient(
