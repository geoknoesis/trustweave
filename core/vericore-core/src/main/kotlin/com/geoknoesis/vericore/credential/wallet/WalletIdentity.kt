 ...
 * Note: DidDocument type is Any to avoid dependency on vericore-did in vericore-core.
 * In implementations, this should be com.geoknoesis.vericore.did.DidDocument.
 * 
 * **Example Usage**:
 * ```kotlin
...
interface CredentialIssuance {
    ...
    ): com.geoknoesis.vericore.credential.models.VerifiableCredential
}
