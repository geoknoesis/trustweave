...
class Ed25519ProofGeneratorAdditionalBranchesTest {
    ...
    fun `test generateProof with null challenge`() = runBlocking {
        ...
        val options = com.geoknoesis.vericore.credential.proof.ProofOptions(
    ...
    fun `test generateProof with credential having null id`() = runBlocking {
        ...
        val proof = generator.generateProof(credential, "key-1", com.geoknoesis.vericore.credential.proof.ProofOptions(proofPurpose = "assertionMethod"))
    ...
    fun `test generateProof with credential having null issuer`() = runBlocking {
        ...
        assertFailsWith<IllegalArgumentException> {
            generator.generateProof(credential, "key-1", com.geoknoesis.vericore.credential.proof.ProofOptions(proofPurpose = "assertionMethod"))
        }
    }
