package com.geoknoesis.vericore.testkit.credential
...
import com.geoknoesis.vericore.credential.wallet.CredentialCollection
import com.geoknoesis.vericore.credential.wallet.CredentialLifecycle
import com.geoknoesis.vericore.credential.wallet.CredentialMetadata
import com.geoknoesis.vericore.credential.wallet.CredentialOrganization
import com.geoknoesis.vericore.credential.wallet.CredentialPresentation
...
class InMemoryWallet(
    ...
    override suspend fun list(filter: com.geoknoesis.vericore.credential.wallet.CredentialFilter?): List<VerifiableCredential> {
    ...
    override suspend fun query(query: com.geoknoesis.vericore.credential.wallet.CredentialQueryBuilder.() -> Unit): List<VerifiableCredential> {
        val builder = com.geoknoesis.vericore.credential.wallet.CredentialQueryBuilder()
        builder.query()
