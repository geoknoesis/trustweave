package com.geoknoesis.vericore.testkit.did
...
class DidKeyMockMethodTest {
    ...
    private class MockKeyManagementService : KeyManagementService {
        ...
        override suspend fun getSupportedAlgorithms(): Set<com.geoknoesis.vericore.kms.Algorithm> {
            return setOf(com.geoknoesis.vericore.kms.Algorithm.Ed25519)
        }

        override suspend fun generateKey(algorithm: com.geoknoesis.vericore.kms.Algorithm, options: Map<String, Any?>): KeyHandle {
        ...
        override suspend fun sign(keyId: String, data: ByteArray, algorithm: com.geoknoesis.vericore.kms.Algorithm?): ByteArray {
