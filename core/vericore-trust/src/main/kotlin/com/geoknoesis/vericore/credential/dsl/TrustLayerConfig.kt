...
class TrustLayerConfig private constructor(
    ...
    class Builder(
        ...
        private fun getDefaultKmsFactory(): KmsFactory {
            ...
            try {
                val factoryClass = Class.forName("com.geoknoesis.vericore.testkit.services.TestkitKmsFactory")
        ...
        private fun getDefaultDidMethodFactory(): DidMethodFactory {
            // Try to get factory from testkit
            try {
                val factoryClass = Class.forName("com.geoknoesis.vericore.testkit.services.TestkitDidMethodFactory")
        ...
        private fun getDefaultAnchorClientFactory(): BlockchainAnchorClientFactory {
            // Try to get factory from testkit
            try {
                val factoryClass = Class.forName("com.geoknoesis.vericore.testkit.services.TestkitBlockchainAnchorClientFactory")
        ...
        private fun getDefaultStatusListManagerFactory(): StatusListManagerFactory {
            // Try to get factory from testkit
            try {
                val factoryClass = Class.forName("com.geoknoesis.vericore.testkit.services.TestkitStatusListManagerFactory")
            ...
            try {
                val managerClass = Class.forName("com.geoknoesis.vericore.credential.revocation.InMemoryStatusListManager")
        ...
        private fun getDefaultTrustRegistryFactory(): TrustRegistryFactory {
            // Try to get factory from testkit
            try {
                val factoryClass = Class.forName("com.geoknoesis.vericore.testkit.services.TestkitTrustRegistryFactory")
        ...
        private fun getDefaultWalletFactory(): WalletFactory? {
            // Try to get factory from testkit
            try {
                val factoryClass = Class.forName("com.geoknoesis.vericore.testkit.services.TestkitWalletFactory")
    ...
    data class DidMethodConfig(
        val algorithm: com.geoknoesis.vericore.did.DidCreationOptions.KeyAlgorithm? = null,
        val domain: String? = null,
        val additionalProperties: Map<String, Any?> = emptyMap()
    ) {
        fun toOptions(kms: Any): com.geoknoesis.vericore.did.DidCreationOptions {
            val resolvedAlgorithm = algorithm ?: com.geoknoesis.vericore.did.DidCreationOptions.KeyAlgorithm.ED25519
            val props = buildMap<String, Any?> {
                putAll(additionalProperties)
                put("kms", kms)
                domain?.let { put("domain", it) }
            }
            return com.geoknoesis.vericore.did.DidCreationOptions(
                algorithm = resolvedAlgorithm,
                purposes = listOf(com.geoknoesis.vericore.did.DidCreationOptions.KeyPurpose.AUTHENTICATION),
    ...
    class DidMethodConfigBuilder {
        private var algorithm: com.geoknoesis.vericore.did.DidCreationOptions.KeyAlgorithm? = null
        private var domain: String? = null
        private val options = mutableMapOf<String, Any?>()
        
        fun algorithm(name: String) {
            algorithm = com.geoknoesis.vericore.did.DidCreationOptions.KeyAlgorithm.fromName(name)
        }
        
        fun algorithm(value: com.geoknoesis.vericore.did.DidCreationOptions.KeyAlgorithm) {
            algorithm = value
        }
    ...
    class SchemaConfigBuilder {
        ...
        var defaultFormat: com.geoknoesis.vericore.spi.SchemaFormat = com.geoknoesis.vericore.spi.SchemaFormat.JSON_SCHEMA
        
        fun autoValidate(enabled: Boolean) {
            autoValidate = enabled
        }
        
        fun defaultFormat(format: com.geoknoesis.vericore.spi.SchemaFormat) {
