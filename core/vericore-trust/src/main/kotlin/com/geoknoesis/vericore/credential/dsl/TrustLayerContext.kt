...
class TrustLayerContext(
     ...
     */
    fun getStatusListManager(): com.geoknoesis.vericore.credential.revocation.StatusListManager? {
        return config.statusListManager as? com.geoknoesis.vericore.credential.revocation.StatusListManager
    }
    
    /**
     * Get the schema registry.
     */
    fun getSchemaRegistry(): com.geoknoesis.vericore.credential.schema.SchemaRegistry {
        return com.geoknoesis.vericore.credential.schema.SchemaRegistry
    }
     ...
     */
    fun getTrustRegistry(): com.geoknoesis.vericore.trust.TrustRegistry? {
        return config.trustRegistry as? com.geoknoesis.vericore.trust.TrustRegistry
    }
     ...
     */
    suspend fun verify(block: VerificationBuilder.() -> Unit): com.geoknoesis.vericore.credential.CredentialVerificationResult {
 ...
 */
suspend fun TrustLayerConfig.verify(block: VerificationBuilder.() -> Unit): com.geoknoesis.vericore.credential.CredentialVerificationResult {
