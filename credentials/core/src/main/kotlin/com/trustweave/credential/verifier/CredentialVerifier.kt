            ...
            if (proofPurpose == "capabilityDelegation" || proofPurpose == "capabilityInvocation") {
                if (didResolver == null) {
                    ...
                    try {
                        ...
                        // Use default adapters for delegation verification
                        val docAccess = com.trustweave.did.services.DidDocumentAccessAdapter()
                        val vmAccess = com.trustweave.did.services.VerificationMethodAccessAdapter()
                        val delegationService = com.trustweave.did.delegation.DelegationService(didResolver, docAccess, vmAccess)
