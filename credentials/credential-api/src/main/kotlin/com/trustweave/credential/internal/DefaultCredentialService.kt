...
internal class DefaultCredentialService(
    ...
    override suspend fun verifyPresentation(
        ...
        if (options.verifyPresentationProof) {
            if (presentation.proof == null) {
                ...
                if (presentation.proof is com.trustweave.credential.model.vc.CredentialProof.LinkedDataProof) {
                    val proof = presentation.proof as com.trustweave.credential.model.vc.CredentialProof.LinkedDataProof
                ...
                } else if (presentation.proof is com.trustweave.credential.model.vc.CredentialProof.SdJwtVcProof) {
    ...
    private fun handleRevocationFailure(
        ...
        error: Throwable,
        reason: String,
        policy: com.trustweave.credential.requests.RevocationFailurePolicy
    ): VerificationResult? {
        return when (policy) {
            com.trustweave.credential.requests.RevocationFailurePolicy.FAIL_CLOSED -> {
            ...
            com.trustweave.credential.requests.RevocationFailurePolicy.FAIL_WITH_WARNING -> {
            ...
            com.trustweave.credential.requests.RevocationFailurePolicy.FAIL_OPEN -> {
