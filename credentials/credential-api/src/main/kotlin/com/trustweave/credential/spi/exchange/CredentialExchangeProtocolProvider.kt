package com.trustweave.credential.spi.exchange
 ...
 * Create a file `META-INF/services/com.trustweave.credential.spi.exchange.CredentialExchangeProtocolProvider`
 * with the content:
 * ```
...
interface CredentialExchangeProtocolProvider {
    ...
    /**
     * Supported protocol names (as strings, will be converted to ExchangeProtocolName).
     */
     ...
     *
     * @param protocolName The protocol name as string (e.g., "didcomm")
