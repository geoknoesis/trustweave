...
import org.trustweave.credential.exchange.internal.DefaultExchangeService
import org.trustweave.credential.exchange.internal.ExchangeProtocols
...
object ExchangeServices {
    ...
    fun createExchangeService(
        ...
        credentialService: CredentialService,
        didResolver: DidResolver,
    ): ExchangeService = DefaultExchangeService(protocolRegistry, credentialService, didResolver)
