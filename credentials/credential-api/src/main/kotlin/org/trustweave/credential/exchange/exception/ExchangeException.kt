package org.trustweave.credential.exchange.exception
...
open class ExchangeException(
        ...
        val supportedOperations: List<String> = emptyList(),
            ...
            message =
                "Protocol '$protocolName' does not support operation '$operation'." +
                    " Supported operations: ${supportedOperations.joinToString()}",
        )
    ...
    data class MissingRequiredOption(
        ...
        val protocolName: String? = null,
            ...
            message =
                protocolName?.let { "Missing required option '$optionName' for protocol '$it'" }
    ...
    data class InvalidRequest(
        ...
        override val cause: Throwable? = null,
            ...
            message =
                protocolName?.let { "Invalid request field '$field' for protocol '$it': $reason" }
    ...
    data class OfferNotFound(
        ...
        val protocolName: String? = null,
            ...
            message =
                protocolName?.let { "Offer '$offerId' not found for protocol '$it'" }
    ...
    data class RequestNotFound(
        ...
        val protocolName: String? = null,
            ...
            message =
                protocolName?.let { "Request '$requestId' not found for protocol '$it'" }
    ...
    data class ProofRequestNotFound(
        ...
        val protocolName: String? = null,
            ...
            message =
                protocolName?.let { "Proof request '$requestId' not found for protocol '$it'" }
    ...
    data class MessageNotFound(
        ...
        val protocolName: String? = null,
            ...
            message =
                protocolName?.let { "Message '$messageId' not found for protocol '$it'" }
    ...
    data class Unknown(
        ...
        override val cause: Throwable? = null,
            ...
            message =
                errorType?.let { "Unknown exchange error ($it): $reason" }
