...
import org.trustweave.credential.exchange.registry.internal.DefaultExchangeProtocolRegistry
...
object ExchangeProtocolRegistries {
     ...
     */
    fun default(): ExchangeProtocolRegistry = DefaultExchangeProtocolRegistry()
}
