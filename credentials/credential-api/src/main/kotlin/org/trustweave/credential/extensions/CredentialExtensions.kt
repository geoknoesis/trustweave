 ...
 */
fun VerifiableCredential.typeStrings(): List<String> = type.map { it.value }
 ...
 */
fun VerifiableCredential.hasType(typeString: String): Boolean = type.any { it.value == typeString }
 ...
 */
fun VerifiableCredential.hasClaim(key: String): Boolean = credentialSubject.claims.containsKey(key)
 ...
 */
fun VerifiablePresentation.credentialCount(): Int = verifiableCredential.size
 ...
 */
fun VerifiablePresentation.isEmpty(): Boolean = verifiableCredential.isEmpty()
 ...
 */
fun VerifiablePresentation.isNotEmpty(): Boolean = verifiableCredential.isNotEmpty()
 ...
 */
fun VerifiablePresentation.allCredentialTypes(): List<String> = verifiableCredential.flatMap { it.typeStrings() }.distinct()
...
fun VerifiablePresentation.credentialsByType(typeString: String): List<VerifiableCredential> =
    verifiableCredential.filter { it.hasType(typeString) }
