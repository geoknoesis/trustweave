 ...
 */
fun Iri.requireIssuerId(): IssuerId = asIssuerIdOrNull() ?: throw IllegalArgumentException("IRI '$value' is not a valid IssuerId")
 ...
 */
fun List<String>.mapToIssuerIdOrNull(): List<IssuerId> = mapNotNull { it.toIssuerIdOrNull() }
 ...
 */
fun List<Iri>.filterIssuerIds(): List<IssuerId> = mapNotNull { it.asIssuerIdOrNull() }
