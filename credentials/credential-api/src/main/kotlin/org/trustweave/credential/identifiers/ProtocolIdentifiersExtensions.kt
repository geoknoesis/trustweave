 ...
 */
fun String.requireOfferId(): OfferId = toOfferIdOrNull() ?: throw IllegalArgumentException("String '$this' is not a valid OfferId")
 ...
 */
fun String.requireRequestId(): RequestId = toRequestIdOrNull() ?: throw IllegalArgumentException("String '$this' is not a valid RequestId")
 ...
 */
fun String.requireIssueId(): IssueId = toIssueIdOrNull() ?: throw IllegalArgumentException("String '$this' is not a valid IssueId")
 ...
 * ```
 */
fun List<String>.mapToExchangeProtocolNameOrNull(): List<ExchangeProtocolName> = mapNotNull { it.toExchangeProtocolNameOrNull() }

/**
 * Map string list to OfferId list, filtering out invalid entries.
 */
fun List<String>.mapToOfferIdOrNull(): List<OfferId> = mapNotNull { it.toOfferIdOrNull() }

/**
 * Map string list to RequestId list, filtering out invalid entries.
 */
fun List<String>.mapToRequestIdOrNull(): List<RequestId> = mapNotNull { it.toRequestIdOrNull() }

/**
 * Map string list to IssueId list, filtering out invalid entries.
 */
fun List<String>.mapToIssueIdOrNull(): List<IssueId> = mapNotNull { it.toIssueIdOrNull() }

/**
 * Map string list to PresentationId list, filtering out invalid entries.
 */
fun List<String>.mapToPresentationIdOrNull(): List<PresentationId> = mapNotNull { it.toPresentationIdOrNull() }
