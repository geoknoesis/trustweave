 ...
 * **With DSL Builder**:
 * ```kotlin
 * val jwt = (credential.transform { toJwt() } as TransformResult.Jwt).value
 * ```
 *
 * @see org.trustweave.credential.internal.transform.CredentialTransformerExtensions For extension functions
...
class CredentialTransformer : CredentialFormatConverter {
     ...
     * @see org.trustweave.credential.internal.transform.toJsonLd Extension function
     */
    override suspend fun toJsonLd(credential: VerifiableCredential): JsonObject {
     ...
     * @see org.trustweave.credential.internal.transform.toCbor Extension function
     */
     ...
     * @see org.trustweave.credential.internal.transform.fromCbor Extension function
     */
    override suspend fun fromCbor(bytes: ByteArray): VerifiableCredential {
        try {
