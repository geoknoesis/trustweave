...
object SchemaRegistries {
     ...
     */
    fun default(): SchemaRegistry = DefaultSchemaRegistry(defaultValidatorRegistry())

    /**
     * Create a schema registry with a custom validator registry.
     */
    fun withValidatorRegistry(validatorRegistry: SchemaValidatorRegistry): SchemaRegistry = DefaultSchemaRegistry(validatorRegistry)
}
