...
internal class DefaultSchemaRegistry(
    ...
    override suspend fun getSchemaDefinition(schemaId: SchemaId): JsonObject? = schemaDefinitions[schemaId]

    override suspend fun getSchemaFormat(schemaId: SchemaId): SchemaFormat? = schemaFormats[schemaId]
    ...
    override suspend fun isRegistered(schemaId: SchemaId): Boolean = schemaDefinitions.containsKey(schemaId)

    override suspend fun getAllSchemaIds(): List<SchemaId> = schemaDefinitions.keys.toList()
