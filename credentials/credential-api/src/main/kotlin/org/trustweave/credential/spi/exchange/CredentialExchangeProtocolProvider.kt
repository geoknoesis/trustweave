package org.trustweave.credential.spi.exchange
 ...
 * Create a file `META-INF/services/org.trustweave.credential.spi.exchange.CredentialExchangeProtocolProvider`
 * with the content:
 * ```
