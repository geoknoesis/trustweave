 ...
 * ```
 *
 * Note: this provider stays in `:credentials:credential-api` (JVM) because it produces
 * [ProofEngine] instances, and ProofEngine itself references `org.trustweave.did.resolver.DidResolver`
 * — which is not yet portable. Move both together when the DID resolver SPI is migrated.
 */
