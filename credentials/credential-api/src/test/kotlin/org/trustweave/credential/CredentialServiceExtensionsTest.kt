...
class CredentialServiceExtensionsTest {
    ...
    @Test
    fun `test toJwt extension function`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test fromJwt extension function`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
            val service = credentialService(didResolver = didResolver)
    ...
    @Test
    fun `test toJwt and fromJwt round trip`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
            val service = credentialService(didResolver = didResolver)
            val originalCredential = createTestCredential()
    ...
    @Test
    fun `test toJsonLd extension function`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
            val service = credentialService(didResolver = didResolver)
            val credential = createTestCredential()
    ...
    @Test
    fun `test fromJsonLd extension function`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
            val service = credentialService(didResolver = didResolver)
            val originalCredential = createTestCredential()
    ...
    @Test
    fun `test toJsonLd and fromJsonLd round trip`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
            val service = credentialService(didResolver = didResolver)
            val originalCredential = createTestCredential()
    ...
    @Test
    fun `test toCbor extension function`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
            val service = credentialService(didResolver = didResolver)
            val credential = createTestCredential()
    ...
    @Test
    fun `test fromCbor extension function`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
            val service = credentialService(didResolver = didResolver)
            val originalCredential = createTestCredential()
    ...
    @Test
    fun `test toCbor and fromCbor round trip`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
            val service = credentialService(didResolver = didResolver)
            val originalCredential = createTestCredential()
    ...
    @Test
    fun `test all format conversions round trip`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
            val service = credentialService(didResolver = didResolver)
            val originalCredential = createTestCredential()
