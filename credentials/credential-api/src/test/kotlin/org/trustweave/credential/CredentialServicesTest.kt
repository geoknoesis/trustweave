...
class CredentialServicesTest {
    @Test
    fun `test credentialService with didResolver only`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test credentialService with all optional parameters`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
    ...
    @Test
    fun `test credentialService with signer function`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
    ...
    @Test
    fun `test credentialService with signer and optional parameters`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
            val kms: KeyManagementService = InMemoryKeyManagementService()
    ...
    @Test
    fun `test createCredentialService with all formats`() =
        runBlocking<Unit> {
            val kms: KeyManagementService = InMemoryKeyManagementService()
            val didResolver = createMockDidResolver()
    ...
    @Test
    fun `test createCredentialService with single format`() =
        runBlocking<Unit> {
            val kms: KeyManagementService = InMemoryKeyManagementService()
            val didResolver = createMockDidResolver()
    ...
    @Test
    fun `test createCredentialService with unsupported format`() =
        runBlocking<Unit> {
            val kms: KeyManagementService = InMemoryKeyManagementService()
            val didResolver = createMockDidResolver()
    ...
    @Test
    fun `test createCredentialService with KMS creates service successfully`() =
        runBlocking<Unit> {
            val didResolver = createMockDidResolver()
            val kms: KeyManagementService = InMemoryKeyManagementService()
