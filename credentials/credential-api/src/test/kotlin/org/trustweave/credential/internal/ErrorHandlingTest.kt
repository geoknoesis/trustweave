...
class ErrorHandlingTest {
    @Test
    fun `test handleIssuanceErrors with successful operation`() =
        runBlocking<Unit> {
            val credential = createTestCredential()

            val result =
                ErrorHandling.handleIssuanceErrors(ProofSuiteId.VC_LD) {
                    credential
                }
    ...
    @Test
    fun `test handleIssuanceErrors with IllegalArgumentException`() =
        runBlocking<Unit> {
            val result =
                ErrorHandling.handleIssuanceErrors(ProofSuiteId.VC_LD) {
    ...
    @Test
    fun `test handleIssuanceErrors with IllegalStateException`() =
        runBlocking<Unit> {
            val result =
                ErrorHandling.handleIssuanceErrors(ProofSuiteId.VC_LD) {
    ...
    @Test
    fun `test handleIssuanceErrors with TimeoutException`() =
        runBlocking<Unit> {
            val result =
                ErrorHandling.handleIssuanceErrors(ProofSuiteId.VC_LD) {
    ...
    @Test
    fun `test handleIssuanceErrors with IOException`() =
        runBlocking<Unit> {
            val result =
                ErrorHandling.handleIssuanceErrors(ProofSuiteId.VC_LD) {
    ...
    @Test
    fun `test handleIssuanceErrors with RuntimeException`() =
        runBlocking<Unit> {
            val result =
                ErrorHandling.handleIssuanceErrors(ProofSuiteId.VC_LD) {
    ...
    @Test
    fun `test handleIssuanceErrors with generic Exception`() =
        runBlocking<Unit> {
            val result =
                ErrorHandling.handleIssuanceErrors(ProofSuiteId.VC_LD) {
    ...
    @Test
    fun `test handleIssuanceErrors with Exception without message`() =
        runBlocking<Unit> {
            val result =
                ErrorHandling.handleIssuanceErrors(ProofSuiteId.VC_LD) {
                    throw Exception()
    ...
    fun `test validateEngineAvailability with available engine`() {
        val mockEngine =
            object : ProofEngine {
                ...
                ): org.trustweave.credential.results.VerificationResult = throw NotImplementedError()
