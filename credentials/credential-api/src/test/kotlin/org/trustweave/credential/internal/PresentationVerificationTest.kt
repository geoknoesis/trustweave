...
class PresentationVerificationTest {
    ...
    fun `test verifyProofFormatSupported with empty engines map`() {
        ...
        val result =
            PresentationVerification.verifyProofFormatSupported(
    ...
    @Test
    fun `test resolvePresentationProofVerificationMethod rejects non-authentication purpose`() =
        kotlinx.coroutines.runBlocking {
            val didResolver =
                object : org.trustweave.did.resolver.DidResolver {
