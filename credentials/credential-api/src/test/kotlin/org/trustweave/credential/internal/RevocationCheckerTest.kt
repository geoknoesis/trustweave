...
class RevocationCheckerTest {
    @Test
    fun `test checkRevocationStatus with no revocation manager`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test checkRevocationStatus with no credentialStatus`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test checkRevocationStatus with non-revoked credential`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
            val mockManager = createMockRevocationManager(RevocationStatus(revoked = false))
    ...
    @Test
    fun `test checkRevocationStatus with revoked credential`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
            val mockManager =
                createMockRevocationManager(
    ...
    @Test
    fun `test checkRevocationStatus with suspended credential`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
            val mockManager =
                createMockRevocationManager(
    ...
    @Test
    fun `test checkRevocationStatus with timeout and FAIL_CLOSED policy`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
    ...
    @Test
    fun `test checkRevocationStatus with timeout and FAIL_OPEN policy`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
            val mockManager = createMockRevocationManagerThrowing(java.util.concurrent.TimeoutException("Timeout"))
    ...
    @Test
    fun `test checkRevocationStatus with timeout and FAIL_WITH_WARNING policy`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
            val mockManager = createMockRevocationManagerThrowing(java.util.concurrent.TimeoutException("Timeout"))
    ...
    @Test
    fun `test checkRevocationStatus with IOException and FAIL_CLOSED policy`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
    ...
    @Test
    fun `test checkRevocationStatus with UnknownHostException`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
            val mockManager =
                createMockRevocationManagerThrowing(
    ...
    @Test
    fun `test checkRevocationStatus with ConnectException`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
            val mockManager =
                createMockRevocationManagerThrowing(
    ...
    @Test
    fun `test checkRevocationStatus with IllegalStateException`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
            val mockManager =
                createMockRevocationManagerThrowing(
    ...
    @Test
    fun `test checkRevocationStatus with IllegalArgumentException`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
            val mockManager =
                createMockRevocationManagerThrowing(
    ...
    @Test
    fun `test checkRevocationStatus with generic Exception`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
            val mockManager =
                createMockRevocationManagerThrowing(
    ...
    private fun createMockRevocationManager(status: RevocationStatus): CredentialRevocationManager =
        object : CredentialRevocationManager {
            override suspend fun checkRevocationStatus(credential: VerifiableCredential): RevocationStatus = status
            ...
            override suspend fun createStatusList(
                ...
                size: Int,
                customId: String?,
            ): StatusListId = throw NotImplementedError()
            ...
            override suspend fun checkStatusByIndex(
                statusListId: StatusListId,
                index: Int,
            ): RevocationStatus = throw NotImplementedError()
            ...
            override suspend fun revokeCredentials(
                ...
                statusListId: StatusListId,
            ): Map<String, Boolean> = throw NotImplementedError()
            ...
            override suspend fun getStatusListStatistics(statusListId: StatusListId): StatusListStatistics? = throw NotImplementedError()

            override suspend fun getStatusList(statusListId: StatusListId): StatusListMetadata? = throw NotImplementedError()

            override suspend fun listStatusLists(issuerDid: String?): List<StatusListMetadata> = throw NotImplementedError()

            override suspend fun deleteStatusList(statusListId: StatusListId): Boolean = throw NotImplementedError()
    ...
    private fun createMockRevocationManagerThrowing(exception: Exception): CredentialRevocationManager =
        object : CredentialRevocationManager {
            override suspend fun checkRevocationStatus(credential: VerifiableCredential): RevocationStatus = throw exception
