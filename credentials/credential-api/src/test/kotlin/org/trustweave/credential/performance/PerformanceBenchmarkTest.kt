...
class PerformanceBenchmarkTest {
    ...
    @Test
    fun `test JSON serialization performance`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test JSON deserialization performance`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
    ...
    @Test
    fun `test CBOR encoding performance`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
    ...
    @Test
    fun `test CBOR decoding performance`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
    ...
    @Test
    fun `test CBOR round trip performance`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
    ...
    @Test
    fun `test large credential serialization performance`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test memory efficiency of CBOR`() =
        runBlocking<Unit> {
            val credential = createTestCredential()
