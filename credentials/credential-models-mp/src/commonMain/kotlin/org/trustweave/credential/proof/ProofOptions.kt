 ...
 *
 * Uses the multiplatform [kotlin.uuid.Uuid] API (stable since Kotlin 2.1) so this
 * function works across all Kotlin targets. Cryptographically suitable for nonce use.
 *
 * **Example:**
 * ```kotlin
