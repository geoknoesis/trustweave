        ...
        return runBlocking {
            try {
                ...
                val keyHandle = when (getKeyResult) {
                    is org.trustweave.kms.results.GetPublicKeyResult.Success -> getKeyResult.keyHandle
                    is org.trustweave.kms.results.GetPublicKeyResult.Failure -> return@runBlocking null
                }
