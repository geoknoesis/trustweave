                ...
                try {
                    ...
                    val updater: (Any) -> Any = { currentDoc ->
                        ...
                        val newVmObjects = newVerificationMethods.map { vmData ->
                            try {
                                val vmClass = Class.forName("com.trustweave.did.VerificationMethodRef")
                        ...
                        val newServiceObjects = newServices.map { serviceData ->
                            try {
                                val serviceClass = Class.forName("com.trustweave.did.Service")
 ...
 */
suspend fun DidDslProvider.updateDid(block: DidDocumentBuilder.() -> Unit): Any {
