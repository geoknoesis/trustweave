...
inline fun String.toVerificationMethodIdOrNull(baseDid: Did? = null): VerificationMethodId? =
    try {
        VerificationMethodId.parse(this, baseDid)
    } catch (e: IllegalArgumentException) {
        null
    }
 ...
 */
fun VerificationMethodId.extractKeyId(): String = this.keyId.fragmentValue
 ...
 */
fun VerificationMethod?.extractKeyId(): String? = this?.id?.extractKeyId()
