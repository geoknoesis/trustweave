...
class FallbackDidResolver(
    ...
    override suspend fun resolve(did: Did): DidResolutionResult =
        when (val result = primary.resolve(did)) {
    ...
    override suspend fun resolve(
        ...
        when (val result = primary.resolve(did, options)) {
 ...
 * ```
 */
fun UniversalResolver.asDidResolver(): DidResolver =
    object : DidResolver {
         ...
         */
        private suspend fun resolveViaUniversal(did: Did): DidResolutionResult =
            try {
