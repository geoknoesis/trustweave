...
class DidMethodRegistryConcurrencyTest {
    @Test
    fun `test concurrent registration`() =
        runTest {
    ...
    @Test
    fun `test concurrent registration and retrieval`() =
        runTest {
            val registry = DidMethodRegistry()
            val methods =
                (1..50).map { i ->
    ...
    @Test
    fun `test concurrent unregister`() =
        runTest {
            val registry = DidMethodRegistry()
            val methods =
                (1..100).map { i ->
    ...
    @Test
    fun `test concurrent getAllMethods`() =
        runTest {
            val registry = DidMethodRegistry()
            val methods =
                (1..50).map { i ->
    ...
    @Test
    fun `test concurrent registration and resolution`() =
        runTest {
            val registry = DidMethodRegistry()
