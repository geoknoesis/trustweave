...
class RegistryBasedResolverPerformanceTest {
    @Test
    fun `test resolution performance`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test resolution with invalid format performance`() =
        runBlocking<Unit> {
            val registry = DidMethodRegistry()
            val resolver = RegistryBasedResolver(registry)
    ...
    @Test
    fun `test resolution with method not registered performance`() =
        runBlocking<Unit> {
            val registry = DidMethodRegistry()
            val resolver = RegistryBasedResolver(registry)
