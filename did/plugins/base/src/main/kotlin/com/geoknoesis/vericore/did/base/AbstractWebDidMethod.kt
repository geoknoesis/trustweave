package com.geoknoesis.vericore.did.base
...
abstract class AbstractWebDidMethod(
     ...
     * @throws VeriCoreException if publishing fails
     */
     ...
     * @throws VeriCoreException if resolution fails
     */
    protected suspend fun resolveFromHttp(did: String): DidResolutionResult = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            val body = response.body ?: throw VeriCoreException("Empty response body")
