package com.geoknoesis.vericore.ethrdid.spi
...
import com.geoknoesis.vericore.ethrdid.EthrDidConfig
    ...
    private fun getOrCreateAnchorClient(
        ...
        return try {
            ...
            throw IllegalStateException(
                ...
                "Provide 'anchorClient' in options or add vericore-polygon dependency for EVM-compatible chains. " +
                "Error: ${e.message}"
            )
        }
    }
