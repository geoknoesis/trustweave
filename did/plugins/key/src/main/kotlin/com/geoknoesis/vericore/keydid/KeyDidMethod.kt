...
class KeyDidMethod(
     ...
     */
    private fun getPublicKeyBytes(keyHandle: com.geoknoesis.vericore.kms.KeyHandle, algorithm: String): ByteArray {
        // Try multibase first
            ...
            return when (algorithm.uppercase()) {
                "ED25519" -> {
                    ...
                    if (x != null) {
                        ...
                        throw VeriCoreException("Missing 'x' field in Ed25519 JWK")
                    }
                }
                "SECP256K1", "P-256", "P-384", "P-521" -> {
                    ...
                    if (x != null && y != null) {
                        ...
                        throw VeriCoreException("Missing 'x' or 'y' field in EC JWK")
                    }
                }
                else -> throw VeriCoreException("Unsupported algorithm for public key extraction: $algorithm")
            }
        }
        
        throw VeriCoreException("KeyHandle must have either publicKeyMultibase or publicKeyJwk")
    }
