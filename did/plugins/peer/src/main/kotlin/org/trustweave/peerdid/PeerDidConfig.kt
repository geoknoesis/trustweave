...
data class PeerDidConfig(
    ...
    companion object {
         ...
         */
        fun numalgo0(): PeerDidConfig = PeerDidConfig(numalgo = NUMALGO_0)

        /**
         * Creates configuration with numalgo 1.
         */
        fun numalgo1(): PeerDidConfig = PeerDidConfig(numalgo = NUMALGO_1)

        /**
         * Creates configuration with numalgo 2 (recommended).
         */
        fun numalgo2(): PeerDidConfig = PeerDidConfig(numalgo = NUMALGO_2)
