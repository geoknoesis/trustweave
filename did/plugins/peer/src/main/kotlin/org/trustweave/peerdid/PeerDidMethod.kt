...
class PeerDidMethod(
     ...
     */
    private fun generateNumalgo0Did(keyHandle: org.trustweave.kms.KeyHandle): String {
     ...
     */
    private fun generateNumalgo1Did(keyHandle: org.trustweave.kms.KeyHandle): String {
     ...
     */
    private fun generateNumalgo2Did(keyHandle: org.trustweave.kms.KeyHandle): String {
