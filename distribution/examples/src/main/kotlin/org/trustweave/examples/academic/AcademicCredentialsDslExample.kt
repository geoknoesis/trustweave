...
fun main() =
    runBlocking {
        ...
        if (issuedCredential.proof != null) {
            val proofType =
                when (val proof = issuedCredential.proof) {
            ...
            val result =
                studentWallet.organize {
                    collection("Education Credentials", "Academic degrees and certificates") {
                        ...
                        tag(
                            stored.id?.value ?: throw IllegalStateException("Credential must have ID"),
                            "degree",
                            "bachelor",
                            "computer-science",
                            "verified",
        ...
        val retrievedCredential =
            studentWallet.get(stored.id?.value ?: throw IllegalStateException("Credential must have ID"))
