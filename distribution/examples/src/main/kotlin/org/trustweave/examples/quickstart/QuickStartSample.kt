 ...
 * Invoke using `./gradlew :distribution:examples:runQuickStartSample`.
 */
fun main(): Unit =
    runBlocking {
        val trustweave =
        ...
        val credentialSubjectForDigest =
            buildJsonObject {
        ...
        val holderDid =
            org.trustweave.did.identifiers
                .Did("did:key:holder-placeholder")
        ...
        val anchorClient =
            requireNotNull(anchorRegistry.get("inmemory:anchor")) {
