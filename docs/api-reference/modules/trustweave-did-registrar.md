...
- Review [DID Registration Specification](../../how-to/integrations/did-registration/OFFICIAL_SPEC.md) for detailed spec compliance
- See [DID Registration Integration Guide](../../how-to/integrations/did-registration/README.md) for JSON-based method registration
