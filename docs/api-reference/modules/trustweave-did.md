...
See [DID Registration Integration Guide](../../how-to/integrations/did-registration/README.md) for detailed information.
...
- **did:ethr** (`org.trustweave:did-plugins-ethr`) – Ethereum DID method. See [Ethereum DID Integration Guide](../../how-to/integrations/ethr-did.md).
...
- **did:jwk** (`org.trustweave:did-plugins-jwk`) – JWK DID method. See [JWK DID Integration Guide](../../how-to/integrations/jwk-did.md).
- **did:peer** (`org.trustweave:did-plugins-peer`) – Peer DID method. See [Peer DID Integration Guide](../../how-to/integrations/peer-did.md).
- **did:plc** (`org.trustweave:did-plugins-plc`) – PLC DID method. See [PLC DID Integration Guide](../../how-to/integrations/plc-did.md).
- **did:ens** (`org.trustweave:did-plugins-ens`) – ENS DID method. See [ENS DID Integration Guide](../../how-to/integrations/ens-did.md).
- **did:polygon** (`org.trustweave:did-plugins-polygon`) – Polygon DID method. See [Polygon DID Integration Guide](../../how-to/integrations/polygon-did.md).
- **did:sol** (`org.trustweave:did-plugins-sol`) – Solana DID method. See [Solana DID Integration Guide](../../how-to/integrations/sol-did.md).
- **did:cheqd** (`org.trustweave:did-plugins-cheqd`) – Cheqd DID method. See [Cheqd DID Integration Guide](../../how-to/integrations/cheqd-did.md).

Additionally, the module supports HTTP-based DID methods through JSON configuration. See [DID Registration Integration Guide](../../how-to/integrations/did-registration/README.md) for details.
...
- Explore [DID Integration Guides](../../how-to/integrations/README.md) for specific method setups
...
- Learn about [DID Registration](../../how-to/integrations/did-registration/README.md) for JSON-based method registration
