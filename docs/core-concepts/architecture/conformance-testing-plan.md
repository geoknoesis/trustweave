...
established by
[`docs/conformance/did-1-1-implementation-report.md`](../../api-reference/conformance/did-1-1-implementation-report.md)
and
[`docs/conformance/W3C-DID-TEST-SUITE.md`](../../api-reference/conformance/W3C-DID-TEST-SUITE.md).
...
| Published implementation reports (W3C VC 2.0, DID 1.1, DIF PE) | Yes | Placeholder for DID 1.1 only — see [DID 1.1 implementation report](../../api-reference/conformance/did-1-1-implementation-report.md) | Phase 1 (now) |
