...
**Ready to use DIDs?**
- [Quick Start – Step 3](../getting-started/quick-start.html#step-3-create-a-did-with-typed-options) - Create your first DID
- [DID Operations Tutorial](../tutorials/did-operations-tutorial.html) - Hands-on DID examples
- [Wallet API Reference – DidManagement](../api-reference/wallet-api.html#didmanagement) - DID management in wallets

**Want to learn more?**
- [Verifiable Credentials](verifiable-credentials.html) - Use DIDs to issue credentials
- [Key Management](key-management.html) - Understand key management for DIDs
- [DID Integration Guides](../integrations/README.html#did-method-integrations) - Implementation guides for all DID methods

**Explore related concepts:**
- [Architecture Overview](../introduction/architecture-overview.html) - Understand TrustWeave architecture
- [Mental Model](../introduction/mental-model.html) - Core concepts and how they fit together
