...
- **Error handling** – `createDid` / `resolveDid` return sealed results; `updateDid` / `rotateKey` return documents or throw domain exceptions. See [Error handling](../advanced/error-handling.md).
