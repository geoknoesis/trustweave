...
- Follow the [Deprecation policy](../reference/deprecation-policy.md). Replace deprecated APIs when warnings appear in your build.
- Consult the [Module maturity matrix](../reference/module-maturity.md) before depending on optional plugins in production.
