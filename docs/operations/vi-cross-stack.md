...
```text
python scripts/vi-cross-stack.py verify --reference .gradle/vi-reference --file build/credentials/plugins/verifiable-intent/qualification/vi-kotlin-immediate.json
python scripts/vi-cross-stack.py verify --reference .gradle/vi-reference --file build/credentials/plugins/verifiable-intent/qualification/vi-kotlin-autonomous.json
```
...
python scripts/vi-cross-stack.py verify --reference .gradle/vi-reference --file build/credentials/plugins/verifiable-intent/qualification/vi-kotlin-checkout.json
