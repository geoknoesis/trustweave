"""Render the fifth review from its recorded evidence; no external assets required."""
import html
import json
import os
...
runbook = link('trustweave-saas', 'docs/round-5-operations.md')

document = f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>TrustWeave · Round 5 engineering review</title><style>
...
</style></head><body><header><div>5 SEPTEMBER 2026 · ROUND 5</div><h1>Engineering review and hardening</h1><p>Exact SDK revision validation and webhook backlog-age correction. All 14 targeted regression tests passed after Docker recovered.</p><a href="../round-4/index.html">Previous review</a> · <a href="findings.json">Findings</a> · <a href="scores.json">Scores</a> · <a href="validation.json">Validation data</a></header><main>
<div class="grid">{score_cards}</div><aside class="notice"><b>A perfect score is not yet supported.</b> The SDK pin is fixed locally. Publication, exact-pair Linux CI, designated staging validation, live billing/provider evidence and production custody decisions remain outstanding. No deployment or publication was performed.</aside>
