"""Render the seventh review from its recorded evidence; no external assets required."""
import html
import json
import os
...
runbook = link('trustweave-saas', 'docs/round-7-operations.md')

document = f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>TrustWeave · Round 7 engineering review</title><style>
...
</style></head><body><header><div>5 SEPTEMBER 2026 · ROUND 7</div><h1>Engineering review and hardening</h1><p>Real Accountly/Kill Bill validation, dedicated billing tenants and guided lost-key replacement. Live payment and hardware-custody limits remain explicit.</p><a href="../round-6/index.html">Previous review</a> · <a href="findings.json">Findings</a> · <a href="scores.json">Scores</a> · <a href="validation.json">Validation data</a></header><main>
<div class="grid">{score_cards}</div><aside class="notice"><b>A perfect score is not yet supported.</b> The SDK pin and local regressions are verified. Publication, exact-pair Linux CI, designated staging validation, payment collection/settlement and hardware-backed custody remain outstanding. Local deployed Accountly validation and issuer-assisted replacement are complete within the tested scope. No deployment or publication was performed.</aside>
