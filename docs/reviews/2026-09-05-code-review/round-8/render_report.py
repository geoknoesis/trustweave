"""Render the eighth review from its recorded evidence; no external assets required."""
import html
import json
import os
...
document = f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>TrustWeave · Round 8 engineering review</title><style>
...
</style></head><body><header><div>5 SEPTEMBER 2026 · ROUND 8</div><h1>Engineering review and hardening</h1><p>Provider deployment policy, cryptographic key integrity and safe migration retries. Actual hardware custody and provider promotion remain open.</p><a href="../round-7/index.html">Previous review</a> · <a href="findings.json">Findings</a> · <a href="scores.json">Scores</a> · <a href="validation.json">Validation data</a></header><main>
<div class="grid">{score_cards}</div><aside class="notice"><b>A perfect score is not yet supported.</b> Local provider-policy and wallet regressions pass. No provider has been promoted to supported, and no hardware signing integration is claimed. The updated SDK source also needs a new coordinated immutable release pair. No deployment or publication was performed.</aside>
