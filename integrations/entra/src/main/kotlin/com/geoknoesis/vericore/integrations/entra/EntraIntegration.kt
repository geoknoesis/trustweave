package com.geoknoesis.vericore.integrations.entra

import com.geoknoesis.vericore.core.VeriCoreException

/**
 * Microsoft Entra ID (Azure AD) integration for VeriCore.
 * 
...
class EntraIntegration(
    ...
    suspend fun issueCredential(
        ...
        throw VeriCoreException(
            "Microsoft Entra ID integration requires Microsoft Graph API implementation. " +
