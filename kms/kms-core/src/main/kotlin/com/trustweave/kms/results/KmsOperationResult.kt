package com.trustweave.kms.results
...
fun GetPublicKeyResult.getOrThrow(): KeyHandle {
    return when (this) {
        ...
        is GetPublicKeyResult.Failure.Error -> throw com.trustweave.core.exception.TrustWeaveException.Unknown(
            message = reason,
            cause = cause
        )
    }
...
fun SignResult.getOrThrow(): ByteArray {
    return when (this) {
        ...
        is SignResult.Failure.UnsupportedAlgorithm -> throw com.trustweave.kms.UnsupportedAlgorithmException(
            reason ?: "Algorithm '${requestedAlgorithm?.name ?: "null"}' is not compatible with key algorithm '${keyAlgorithm.name}'"
        )
        is SignResult.Failure.Error -> throw com.trustweave.core.exception.TrustWeaveException.Unknown(
            message = reason,
            cause = cause
        )
    }
...
fun GenerateKeyResult.getOrThrow(): KeyHandle {
    return when (this) {
        ...
        is GenerateKeyResult.Failure.UnsupportedAlgorithm -> throw com.trustweave.kms.UnsupportedAlgorithmException(
        ...
        is GenerateKeyResult.Failure.Error -> throw com.trustweave.core.exception.TrustWeaveException.Unknown(
            message = reason,
            cause = cause
        )
    }
...
fun DeleteKeyResult.getOrThrow(): Boolean {
    return when (this) {
        ...
        is DeleteKeyResult.Failure.Error -> throw com.trustweave.core.exception.TrustWeaveException.Unknown(
            message = reason,
            cause = cause
        )
    }
