...
class AzureKeyManagementService(
    ...
    override suspend fun generateKey(
        ...
        try {
            ...
            val keyName = (options["keyName"] as? String) ?: "vericore-key-${UUID.randomUUID()}"
    ...
    /**
     * Maps Azure Key Vault exceptions to VeriCore exceptions.
     */
    ...
    private fun extractPublicKeyBytesFromJwk(
        ...
        return when (algorithm) {
            is Algorithm.Secp256k1, is Algorithm.P256, is Algorithm.P384, is Algorithm.P521 -> {
                ...
                val y = jwk.y
                if (x == null || y == null) {
                    throw VeriCoreException("Missing x or y coordinates in EC key")
                }
            ...
            is Algorithm.RSA -> {
                ...
                val e = jwk.e
                if (n == null || e == null) {
                    throw VeriCoreException("Missing modulus or exponent in RSA key")
                }
            ...
            else -> throw VeriCoreException("Unsupported algorithm for key extraction: ${algorithm.name}")
        }
    }
