 ...
 *
 * Entrust nShield is deliberately unimplemented: it needs the vendor SDK and HSM access, neither of which
 ...
 */
class EntrustStubFailsClosedTest {
    private val kms =
        EntrustKeyManagementService(
            EntrustKmsConfig(
