...
/**
 * Utilities for mapping between VeriCore Algorithm types and Fortanix DSM types.
 */
object AlgorithmMapping {
    /**
     * Maps VeriCore Algorithm to Fortanix DSM key type.
     * 
    ...
    /**
     * Maps VeriCore Algorithm to Fortanix DSM curve name.
     * 
     * @param algorithm VeriCore algorithm
    ...
    /**
     * Maps VeriCore Algorithm to Fortanix DSM key size (for RSA).
     * 
     * @param algorithm VeriCore algorithm
    ...
    /**
     * Parses Fortanix DSM key type to VeriCore Algorithm.
     * 
    ...
    /**
     * Maps VeriCore Algorithm to Fortanix DSM signing algorithm.
     * 
     * @param algorithm VeriCore algorithm
