...
class VaultKeyManagementService(
    ...
    override suspend fun generateKey(
        ...
        try {
            ...
            } ?: throw VeriCoreException("Failed to retrieve public key from Vault")
    ...
    override suspend fun getPublicKey(keyId: String): KeyHandle = withContext(Dispatchers.IO) {
        try {
            ...
            val keyType = keyInfo.data["type"] as? String
                ?: throw VeriCoreException("Key type not found in Vault response")
            ...
            val publicKeyPem = versionData?.get("public_key") as? String
                ?: throw VeriCoreException("Public key not found for key: $keyId")
    ...
    override suspend fun sign(
        ...
        try {
            ...
            val signature = signResponse.data["signature"] as? String
                ?: throw VeriCoreException("Signature not found in Vault response")
    ...
    /**
     * Maps Vault exceptions to VeriCore exceptions.
     */
