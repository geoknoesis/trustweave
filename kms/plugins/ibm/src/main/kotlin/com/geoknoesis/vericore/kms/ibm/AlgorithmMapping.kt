...
/**
 * Utilities for mapping between VeriCore Algorithm types and IBM Key Protect types.
 */
object AlgorithmMapping {
    /**
     * Maps VeriCore Algorithm to IBM Key Protect key type.
     * 
    ...
    /**
     * Parses IBM Key Protect key type to VeriCore Algorithm.
     * 
    ...
    /**
     * Maps VeriCore Algorithm to IBM Key Protect signing algorithm.
     * 
     * @param algorithm VeriCore algorithm
