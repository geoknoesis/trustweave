 ...
 *
 * Thales Luna is deliberately unimplemented: it needs the vendor SDK and HSM access, neither of which
 ...
 */
class ThalesLunaStubFailsClosedTest {
    private val kms =
        ThalesLunaKeyManagementService(
            ThalesLunaKmsConfig(
