package com.geoknoesis.vericore.waltid.did
...
class WaltIdKeyMethod(
    ...
    override suspend fun resolveDid(did: String): DidResolutionResult = withContext(Dispatchers.IO) {
        try {
            ...
            DidResolutionResult(
                document = document,
                documentMetadata = com.geoknoesis.vericore.did.DidDocumentMetadata(
                    created = now,
                    updated = now
                ),
...
class WaltIdDidMethodProvider : DidMethodProvider {
    ...
    override fun create(methodName: String, options: com.geoknoesis.vericore.did.DidCreationOptions): DidMethod? {
        ...
        val kms = options.additionalProperties["kms"] as? KeyManagementService
            ?: run {
                ...
                val kmsProviders = java.util.ServiceLoader.load(com.geoknoesis.vericore.kms.spi.KeyManagementServiceProvider::class.java)
