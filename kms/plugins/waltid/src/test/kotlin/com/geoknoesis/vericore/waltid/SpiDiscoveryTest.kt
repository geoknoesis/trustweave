...
class SpiDiscoveryTest {
    ...
    fun `META-INF services files should exist`() {
        val kmsServiceFile = this::class.java.classLoader
            .getResource("META-INF/services/com.geoknoesis.vericore.kms.spi.KeyManagementServiceProvider")
        ...
        val didServiceFile = this::class.java.classLoader
            .getResource("META-INF/services/com.geoknoesis.vericore.did.spi.DidMethodProvider")
