...
/**
 * Test-side CA used to issue end-entity certs around KMS-managed public keys.
 *
 * Inlined from the `signatures:jades` test fixtures (test sources are not shared across
 * modules in this project).
 */
internal class TestCa(
    val caSubject: String = "CN=TrustWeave ETSI Validation Test CA, O=TrustWeave, C=EU",
) {
