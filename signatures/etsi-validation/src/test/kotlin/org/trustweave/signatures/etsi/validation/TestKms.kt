...
/**
 * Tiny in-process [KeyManagementService] backed by Bouncy Castle key pairs.
 *
 * Inlined from `signatures:jades` test sources because Gradle test fixtures are not shared
 * across modules in this project. Behaviour is identical to the JAdES fixture.
 */
