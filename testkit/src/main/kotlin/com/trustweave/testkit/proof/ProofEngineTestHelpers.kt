...
import com.trustweave.credential.proof.proofOptionsForAuthentication
...
class ProofEngineTestHelpers(
    private val fixture: com.trustweave.testkit.TrustWeaveTestFixture
) {
    ...
    fun createPresentationRequest(
        ...
        predicates: List<com.trustweave.credential.requests.Predicate> = emptyList(),
        proofOptions: ProofOptions? = null
    ): PresentationRequest {
 ...
 */
suspend fun com.trustweave.testkit.TrustWeaveTestFixture.proofEngineHelpers(): ProofEngineTestHelpers {
