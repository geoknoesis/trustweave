package com.trustweave.trust.benchmarks
...
open class TrustWeaveBenchmarks {
    ...
    fun setup() = runBlocking {
        ...
        trustWeave = TrustWeave.build {
            factories(
                kmsFactory = com.trustweave.testkit.kms.TestkitKmsFactory(),
                didMethodFactory = com.trustweave.testkit.did.TestkitDidMethodFactory()
            )
            keys {
                provider("inMemory")
                algorithm("Ed25519")
