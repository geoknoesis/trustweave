...
class InMemoryTrustWeaveIntegrationTest {
    ...
    private suspend fun createTrustWeaveWithCredentialService(
        ...
        val patchedConfig = finalTrustWeave.configuration.copy(
    ...
    fun `test credential revocation workflow template`() = runBlocking {
        ...
        assertTrue(revokedResult is org.trustweave.credential.results.VerificationResult.Invalid.Revoked, "Credential should be revoked")
    }
