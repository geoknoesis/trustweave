...
class DelegationDslTest {
    @Test
    fun `delegation verifier accepts valid delegator to delegate link`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `delegation verifier accepts capability delegation reference`() =
        runBlocking<Unit> {
            val delegatorDid = "did:key:delegator"
            val delegateDid = "did:key:delegate"
    ...
    @Test
    fun `delegation verifier fails when resolution returns nothing`() =
        runBlocking<Unit> {
