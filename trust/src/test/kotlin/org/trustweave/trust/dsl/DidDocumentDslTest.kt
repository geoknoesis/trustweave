...
class DidDocumentDslTest {
    ...
    @Test
    fun `test updateDid add service`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
    ...
    @Test
    fun `test updateDid remove service`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
    ...
    @Test
    fun `test updateDid without DID returns UpdateFailed`() =
        runBlocking<Unit> {
            val result =
                trustWeave.updateDid {
                    addKey {
    ...
    @Test
    fun `test updateDid add service without required fields throws exception`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
    ...
    @Test
    fun `test updateDid add key with multibase`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
    ...
    @Test
    fun `test updateDid add multiple keys and services`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
    ...
    @Test
    fun `test updateDid auto-detects method from DID`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
    ...
    @Test
    fun `test updateDid via TrustWeaveContext`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
