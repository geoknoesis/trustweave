...
class KeyRotationDslTest {
    ...
    @Test
    fun `test rotateKey succeeds with quickStart config`() =
        runBlocking<Unit> {
            ...
            val result =
                quickStartTrustWeave.rotateKey {
                    did(did.value)
                    algorithm("Ed25519")
                }
    ...
    @Test
    fun `test rotateKey without DID returns failure`() =
        runBlocking<Unit> {
            val result =
                trustWeave.rotateKey {
                    algorithm("Ed25519")
    ...
    @Test
    fun `test rotateKey with removeOldKey`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
    ...
    @Test
    fun `test rotateKey auto-detects method from DID`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
    ...
    @Test
    fun `test rotateKey with unconfigured method returns failure`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
    ...
    @Test
    fun `test rotateKey via TrustWeaveContext`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
    ...
    @Test
    fun `test rotateKey with multiple old keys`() =
        runBlocking<Unit> {
            val did =
                trustWeave
                    .createDid {
