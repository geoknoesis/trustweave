...
class PresentationDslTest {
    ...
    @Test
    fun `test presentation creation with single credential`() =
        runBlocking<Unit> {
            val credential =
                issueTestCredential(
    ...
    @Test
    fun `test presentation creation with multiple credentials`() =
        runBlocking<Unit> {
            val credential1 =
                issueTestCredential(
                    type = "PersonCredential",
    ...
    @Test
    fun `test presentation creation with challenge`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test presentation creation with domain`() =
        runBlocking<Unit> {
            val credential = issueTestCredential(type = "PersonCredential")
    ...
    @Test
    fun `test presentation creation with custom proof type`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `holder string must be a did colon prefix`() =
        runBlocking<Unit> {
            val credential = issueTestCredential(type = "PersonCredential")
    ...
    @Test
    fun `test presentation creation requires credentials`() =
        runBlocking<Unit> {
            val r =
                trustWeave.presentationResult {
                    holder("did:key:holder")
    ...
    @Test
    fun `test presentation creation requires holder`() =
        runBlocking<Unit> {
            val credential =
                credential {
                    type("PersonCredential")
    ...
    @Test
    fun `test presentation with selective disclosure`() =
        runBlocking<Unit> {
            val credential =
                issueTestCredential(
                    type = "PersonCredential",
