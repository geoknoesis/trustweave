...
class SchemaDslTest {
    ...
    @Test
    fun `test register SHACL schema`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test register schema without id throws exception`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test register schema without definition throws exception`() =
        runBlocking<Unit> {
            assertFailsWith<IllegalStateException> {
                trustWeave.registerSchema {
    ...
    @Test
    fun `test validate credential against schema`() =
        runBlocking<Unit> {
            val schemaId = "https://example.com/schemas/person"
            ...
            val credential =
                VerifiableCredential(
                    type =
                        listOf(
                            org.trustweave.credential.model.CredentialType.VerifiableCredential,
                            org.trustweave.credential.model.CredentialType
                                .Custom("PersonCredential"),
                        ),
                    issuer =
    ...
    @Test
    fun `test schema builder with format override`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test schema builder definition method`() =
        runBlocking<Unit> {
            val schemaId = "https://example.com/schemas/test"
            val definition =
                buildJsonObject {
    ...
    @Test
    fun `test validate credential against unregistered schema throws exception`() =
        runBlocking<Unit> {
            val credential =
                VerifiableCredential(
