...
class VerificationDslTest {
    ...
    @Test
    fun `test verification with default options`() =
        runBlocking<Unit> {
            val credential =
                credential {
    ...
    @Test
    fun `test verification with revocation check enabled`() =
        runBlocking<Unit> {
            val credential =
                credential {
                    type("PersonCredential")
    ...
    @Test
    fun `test verification with revocation check disabled`() =
        runBlocking<Unit> {
            val credential =
                credential {
                    type("PersonCredential")
    ...
    @Test
    fun `test verification with expiration check enabled`() =
        runBlocking<Unit> {
            val credential =
                credential {
                    type("PersonCredential")
    ...
    @Test
    fun `test verification with expiration check disabled`() =
        runBlocking<Unit> {
            val credential =
                credential {
                    type("PersonCredential")
    ...
    @Test
    fun `test verification with schema validation`() =
        runBlocking<Unit> {
            val credential =
                credential {
                    type("PersonCredential")
    ...
    @Test
    fun `test verification with anchor verification`() =
        runBlocking<Unit> {
            val credential =
                credential {
                    type("PersonCredential")
    ...
    @Test
    fun `test verification requires credential`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `test verify credential direct overload`() =
        runBlocking<Unit> {
            val credential =
                credential {
                    type("PersonCredential")
