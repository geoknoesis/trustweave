 ...
 */
suspend fun VerifiableCredential.checkRevocation(trustLayer: TrustLayerContext): io.geoknoesis.vericore.credential.revocation.RevocationStatus {
 ...
 * @return Revocation status
 */
suspend fun StoredCredential.checkRevocation(trustLayer: TrustLayerContext): io.geoknoesis.vericore.credential.revocation.RevocationStatus {
...
suspend fun VerifiableCredential.validateSchema(
    trustLayer: TrustLayerContext,
    schemaId: String
): io.geoknoesis.vericore.credential.schema.SchemaValidationResult {
