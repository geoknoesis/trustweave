...
class CredentialVerifierAdditionalBranchCoverageTest {
    ...
    @BeforeEach
    fun setup() {
        com.geoknoesis.vericore.credential.schema.SchemaRegistry.clear()
    }
    ...
    fun `test CredentialVerifier verify with validateSchema true and schema registered`() = runBlocking {
        ...
        com.geoknoesis.vericore.credential.schema.SchemaRegistry.registerSchema(schema, schemaDef)
        com.geoknoesis.vericore.credential.schema.SchemaValidatorRegistry.clear()
        com.geoknoesis.vericore.credential.schema.SchemaValidatorRegistry.register(
            com.geoknoesis.vericore.credential.schema.JsonSchemaValidator()
        )
