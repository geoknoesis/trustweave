...
class WalletInterfaceTest {
    ...
    private fun createPresentationWallet(): Wallet {
        return object : Wallet, CredentialPresentation {
            ...
            override suspend fun createPresentation(credentialIds: List<String>, holderDid: String, options: com.geoknoesis.vericore.credential.PresentationOptions) = TODO()
            override suspend fun createSelectiveDisclosure(credentialIds: List<String>, disclosedFields: List<String>, holderDid: String, options: com.geoknoesis.vericore.credential.PresentationOptions) = TODO()
        }
    }
    ...
    private fun createIssuanceWallet(): Wallet {
        return object : Wallet, CredentialIssuance {
            ...
            override suspend fun issueCredential(subjectDid: String, credentialType: String, claims: Map<String, Any>, options: com.geoknoesis.vericore.credential.CredentialIssuanceOptions) = TODO()
        }
    }
    ...
    private fun createTestCredential(
        ...
        proof: com.geoknoesis.vericore.credential.models.Proof? = null,
    ...
    private fun createTestProof(): com.geoknoesis.vericore.credential.models.Proof {
        return com.geoknoesis.vericore.credential.models.Proof(
