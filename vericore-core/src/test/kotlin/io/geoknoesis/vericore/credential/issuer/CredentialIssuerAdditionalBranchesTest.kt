...
class CredentialIssuerAdditionalBranchesTest {
    ...
    fun `test issue with credential having termsOfUse`() = runBlocking {
        val termsOfUse = io.geoknoesis.vericore.credential.models.TermsOfUse(
            id = "terms-1",
            type = "IssuerPolicy",
    ...
    fun `test issue with credential having refreshService`() = runBlocking {
        val credential = createTestCredential(
            refreshService = io.geoknoesis.vericore.credential.models.RefreshService(
                id = "refresh-1",
    ...
    private fun createTestCredential(
        ...
        termsOfUse: io.geoknoesis.vericore.credential.models.TermsOfUse? = null,
        refreshService: io.geoknoesis.vericore.credential.models.RefreshService? = null,
        schema: io.geoknoesis.vericore.credential.models.CredentialSchema? = null
