...
class Ed25519ProofGeneratorAdditionalBranchesTest {
    ...
    fun `test generateProof with null challenge`() = runBlocking {
        ...
        val options = io.geoknoesis.vericore.credential.proof.ProofOptions(
    ...
    fun `test generateProof with credential having null id`() = runBlocking {
        ...
        val proof = generator.generateProof(credential, "key-1", io.geoknoesis.vericore.credential.proof.ProofOptions(proofPurpose = "assertionMethod"))
    ...
    fun `test generateProof with credential having null issuer`() = runBlocking {
        ...
        assertFailsWith<IllegalArgumentException> {
            generator.generateProof(credential, "key-1", io.geoknoesis.vericore.credential.proof.ProofOptions(proofPurpose = "assertionMethod"))
        }
    }
