...
class CredentialVerifierAdditionalBranchCoverageTest {
    ...
    @BeforeEach
    fun setup() {
        io.geoknoesis.vericore.credential.schema.SchemaRegistry.clear()
    }
    ...
    fun `test CredentialVerifier verify with validateSchema true and schema registered`() = runBlocking {
        ...
        io.geoknoesis.vericore.credential.schema.SchemaRegistry.registerSchema(schema, schemaDef)
        io.geoknoesis.vericore.credential.schema.SchemaValidatorRegistry.clear()
        io.geoknoesis.vericore.credential.schema.SchemaValidatorRegistry.register(
            io.geoknoesis.vericore.credential.schema.JsonSchemaValidator()
        )
    ...
    private fun createTestCredential(
        ...
        credentialSchema: io.geoknoesis.vericore.credential.models.CredentialSchema? = null,
        proof: Proof? = Proof(
