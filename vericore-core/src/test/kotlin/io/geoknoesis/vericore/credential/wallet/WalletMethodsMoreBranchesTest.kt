...
class WalletMethodsMoreBranchesTest {
    ...
    fun `test supports with CredentialStorage interface`() = runBlocking {
        ...
        assertTrue(wallet is CredentialStorage)
    }
    ...
    private fun createMockWallet(): Wallet {
        return object : Wallet {
            ...
            override suspend fun get(id: String): VerifiableCredential? = storage[id]
            ...
            override suspend fun query(builder: CredentialQueryBuilder.() -> Unit): List<VerifiableCredential> {
                val query = CredentialQueryBuilder().apply(builder)
                return query.toPredicate().let { predicate ->
    ...
    private fun createMockOrganizationWallet(): Wallet {
        ...
        return object : Wallet, CredentialOrganization by object : CredentialOrganization {
            ...
            override suspend fun getCollection(id: String): CredentialCollection? = null
            override suspend fun listCollections(): List<CredentialCollection> = emptyList()
            override suspend fun deleteCollection(id: String): Boolean = false
            ...
            override suspend fun get(id: String) = baseWallet.get(id)
            override suspend fun list(filter: CredentialFilter?) = baseWallet.list(filter)
            override suspend fun delete(id: String) = baseWallet.delete(id)
            override suspend fun query(builder: CredentialQueryBuilder.() -> Unit) = baseWallet.query(builder)
    ...
    private fun createMockPresentationWallet(): Wallet {
        ...
        return object : Wallet, CredentialPresentation by object : CredentialPresentation {
            override suspend fun createPresentation(
                ...
                return io.geoknoesis.vericore.credential.models.VerifiablePresentation(
                    id = "presentation-123",
