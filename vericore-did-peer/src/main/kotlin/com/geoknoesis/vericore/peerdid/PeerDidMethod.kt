...
class PeerDidMethod(
     ...
     */
    private fun generateNumalgo0Did(keyHandle: com.geoknoesis.vericore.kms.KeyHandle): String {
     ...
     */
    private fun generateNumalgo1Did(keyHandle: com.geoknoesis.vericore.kms.KeyHandle): String {
        // Numalgo 1 uses inception key
        // Simplified implementation
        val publicKey = keyHandle.publicKeyMultibase
            ?: throw VeriCoreException("Public key multibase required for numalgo 1")
     ...
     */
    private fun generateNumalgo2Did(keyHandle: com.geoknoesis.vericore.kms.KeyHandle): String {
        // Numalgo 2 uses multibase encoding
        // Simplified implementation
        val publicKey = keyHandle.publicKeyMultibase
            ?: throw VeriCoreException("Public key multibase required for numalgo 2")
