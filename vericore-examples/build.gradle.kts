...
tasks.register<JavaExec>("runEarthObservation") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.eo.EarthObservationExampleKt")
...
tasks.register<JavaExec>("runAcademicCredentials") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.academic.AcademicCredentialsExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runProfessionalIdentity") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.professional.ProfessionalIdentityExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runProofOfLocation") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.location.ProofOfLocationExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runSpatialWeb") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.spatial.SpatialWebExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runDigitalWorkflow") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.workflow.DigitalWorkflowExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runNewsIndustry") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.news.NewsIndustryExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runDataCatalog") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.dcat.DataCatalogExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runHealthcare") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.healthcare.HealthcareExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runGovernment") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.government.GovernmentIdentityExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runSupplyChain") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.supplychain.SupplyChainExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runFinancialServices") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.financial.FinancialServicesExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runIoT") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.iot.IoTDeviceExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
...
tasks.register<JavaExec>("runNationalEducation") {
    ...
    mainClass.set("io.geoknoesis.vericore.examples.national.NationalEducationExampleKt")
    classpath = sourceSets["main"].runtimeClasspath
}
