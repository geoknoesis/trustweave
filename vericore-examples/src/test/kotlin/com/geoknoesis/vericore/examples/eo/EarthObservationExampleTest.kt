...
class EarthObservationExampleTest {
    ...
    fun `test linkset creation`() = runBlocking {
        ...
        val linksetDigest = com.geoknoesis.vericore.json.DigestUtils.sha256DigestMultibase(linksetWithoutDigest as JsonElement)
    ...
    fun `test integrity verification`() = runBlocking {
        ...
        val vcDigest = com.geoknoesis.vericore.json.DigestUtils.sha256DigestMultibase(vcWithoutMetadata as JsonElement)
