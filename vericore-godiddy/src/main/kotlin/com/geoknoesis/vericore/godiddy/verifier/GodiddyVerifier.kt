package com.geoknoesis.vericore.godiddy.verifier

import com.geoknoesis.vericore.core.VeriCoreException
import com.geoknoesis.vericore.godiddy.GodiddyClient
import com.geoknoesis.vericore.godiddy.models.GodiddyVerifyCredentialRequest
import com.geoknoesis.vericore.godiddy.models.GodiddyVerifyCredentialResponse
...
class GodiddyVerifier(
    ...
    suspend fun verifyCredential(
        ...
        try {
            ...
            throw VeriCoreException("Failed to verify credential: ${e.message}", e)
        }
    }
