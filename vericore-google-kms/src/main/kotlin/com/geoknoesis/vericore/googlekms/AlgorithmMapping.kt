...
/**
 * Utilities for mapping between VeriCore Algorithm types and Google Cloud KMS types.
 */
object AlgorithmMapping {
    /**
     * Maps VeriCore Algorithm to Google Cloud KMS CryptoKeyVersionAlgorithm.
     * 
     ...
     * @return VeriCore Algorithm, or null if not supported
     */
            ...
            when (algorithm) {
                is Algorithm.Ed25519 -> {
                    ...
                    mapOf(
                        "kty" to "OKP",
                        "crv" to "Ed25519",
                        "x" to Base64.getUrlEncoder().withoutPadding().encodeToString(publicKeyBytes)
                    )
                }
