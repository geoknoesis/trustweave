...
import com.geoknoesis.vericore.testkit.integrity.models.*
...
class IntegrityVerifierTest {
    ...
    fun `test verifyVcIntegrity`() = runBlocking {
        ...
        val vcDigest = com.geoknoesis.vericore.json.DigestUtils.sha256DigestMultibase(vc)
    ...
    fun `test verifyLinksetIntegrity`() {
        ...
        val linksetDigest = com.geoknoesis.vericore.json.DigestUtils.sha256DigestMultibase(
            buildJsonObject {
    ...
    fun `test verifyArtifactIntegrity`() {
        ...
        val contentDigest = com.geoknoesis.vericore.json.DigestUtils.sha256DigestMultibase(content)
    ...
    fun `test verifyIntegrityChain`() = runBlocking {
        ...
        val artifactDigest = com.geoknoesis.vericore.json.DigestUtils.sha256DigestMultibase(artifactContent)
        val artifact = buildJsonObject {
            put("id", "artifact-1")
        ...
        val vcDigest = com.geoknoesis.vericore.json.DigestUtils.sha256DigestMultibase(
            buildJsonObject {
