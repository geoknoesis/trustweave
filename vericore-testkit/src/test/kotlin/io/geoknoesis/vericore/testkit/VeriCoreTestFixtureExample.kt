...
/**
 * Example test demonstrating the use of VeriCoreTestFixture.
 * 
 ...
 */
class VeriCoreTestFixtureExample {

    @Test
    fun `test using VeriCoreTestFixture minimal setup`() = runBlocking {
    ...
    @Test
    fun `test using VeriCoreTestFixture builder pattern`() = runBlocking {
    ...
    @Test
    fun `test EO workflow with VeriCoreTestFixture`() = runBlocking {
        VeriCoreTestFixture.builder()
            .withInMemoryBlockchainClient("algorand:testnet")
            .build()
            .use { fixture ->
