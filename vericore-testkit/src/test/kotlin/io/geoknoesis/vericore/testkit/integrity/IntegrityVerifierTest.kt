...
class IntegrityVerifierTest {
    ...
    fun `test verifyVcIntegrity`() = runBlocking {
        ...
        val vcDigest = io.geoknoesis.vericore.json.DigestUtils.sha256DigestMultibase(vc)
    ...
    fun `test verifyLinksetIntegrity`() {
        ...
        val linksetDigest = io.geoknoesis.vericore.json.DigestUtils.sha256DigestMultibase(
            buildJsonObject {
    ...
    fun `test verifyArtifactIntegrity`() {
        ...
        val contentDigest = io.geoknoesis.vericore.json.DigestUtils.sha256DigestMultibase(content)
    ...
    fun `test verifyIntegrityChain`() = runBlocking {
        ...
        val vcDigest = io.geoknoesis.vericore.json.DigestUtils.sha256DigestMultibase(
            buildJsonObject {
