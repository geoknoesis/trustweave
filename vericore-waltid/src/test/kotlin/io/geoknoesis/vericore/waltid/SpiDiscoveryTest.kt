...
class SpiDiscoveryTest {
    ...
    fun `META-INF services files should exist`() {
        val kmsServiceFile = this::class.java.classLoader
            .getResource("META-INF/services/io.geoknoesis.vericore.kms.spi.KeyManagementServiceProvider")
        ...
        val didServiceFile = this::class.java.classLoader
            .getResource("META-INF/services/io.geoknoesis.vericore.did.spi.DidMethodProvider")
